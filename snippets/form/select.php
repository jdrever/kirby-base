...
if (isset($label)) : ?>
<label for="<?=$id?>" class="col-form-label"><?=$label?><?php if (!empty($required)) : ?> <span class="visually-hidden">(required)</span><span class="text-danger" aria-hidden="true">*</span><?php endif ?></label>
<?php endif ?>
